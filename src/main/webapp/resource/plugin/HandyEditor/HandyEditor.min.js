...
!function () {
    window.HE = {
        config: {
            ...
            ediv.className = "HandyEditor_editor", ediv.style.textIndent = "27px",ediv.setAttribute("contenteditable", !0), this.config.autoHeight ? (ediv.style.minHeight = this.config.height, ediv.style.height = "auto", ediv.style.textIndent = "27px",ediv.style.overflowY = "hidden") : (ediv.style.height = this.config.height, ediv.style.overflow = "auto"), this.define.obj = ediv, hediv.appendChild(mkdiv);
