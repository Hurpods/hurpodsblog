...
!function () {
    window.HE = {
        config: {
            ...
            this.loadcss(d + "/external/css/HandyEditor.css"), void 0 !== i && this.extend(this.config, i);
            var a = this.config.skin;
            ".css" == a.substr(a.length - 4) && (this.config.skin = a.substr(0, a.length - 4)), this.loadcss(d + "/skin/" + this.config.skin + ".css");
            var r = this.config.externalSkin;
            return "" != r && ".css" == r.substr(r.length - 4) && this.loadcss(this.config.externalSkin), this.loadScript(d + "/lang/" + this.config.lang + "/" + this.config.lang + ".js", function () {
                for (var n in lang) {
                    var d = HE.trim(n.toLowerCase()), t = lang[n];
                    delete lang[n], lang[d] = t
                }
                HE.define.lang = lang, lang = null, HE.handyEditor(e, i)
            }), this
        }, handyEditor: function (id, options) {
            var hetxt = document.getElementById(id);
            this.define.id = hetxt.id, hetxt.style.display = "none";
            var hediv = document.createElement("div");
            hediv.className = "HandyEditor", hediv.style.width = this.config.width;
            var mkdiv = document.createElement("div"), mdiv = document.createElement("div");
            mdiv.id = "HandyEditor_menu", mdiv.className = "HandyEditor_menu", mdiv.style.position = "relative", mdiv.style.outline = "none", mdiv.setAttribute("tabindex", 0);
            var menu = "";
            ...
            ediv.className = "HandyEditor_editor", ediv.setAttribute("contenteditable", !0), this.config.autoHeight ? (ediv.style.minHeight = this.config.height, ediv.style.height = "auto",ediv.style.textIndent = "27px", ediv.style.overflowY = "hidden") : (ediv.style.height = this.config.height, ediv.style.overflow = "auto",ediv.style.textIndent = "27px"), this.define.obj = ediv, hediv.appendChild(mkdiv);
            var mwdiv = document.createElement("div");
            for (var i in mwdiv.style.zIndex = "9000", this.define.mwobj = mwdiv, mwdiv.appendChild(mdiv), hediv.appendChild(mwdiv), this.define.mobj = mdiv, hediv.appendChild(ediv), this.define.hobj = hediv, heparent = hetxt.parentNode, heparent.insertBefore(hediv, hetxt), this.define.obj.innerHTML = hetxt.value, this.define.hetxt = hetxt, this.config.item) {
                var icon = this.trim(this.config.item[i].toLowerCase());
                if ("|" != icon) {
            ...
            this.define.obj.onclick = this.editorClick, this.define.mobj.onclick = this.menukongClick, this.config.autoFloat && (window.onscroll = function () {
                ...
                if (i.altKey && i.shiftKey) if (document.getElementById("HandyEditor_infodiv")) HE.define.mobj.removeChild(document.getElementById("HandyEditor_infodiv")); else {
                    var n = document.createElement("div");
                    n.className = "HandyEditor_infodiv", n.id = "HandyEditor_infodiv";
                    ...
                    n.innerHTML = d, n.style.position = "absolute", n.style.left = "0px", n.style.border = "solid #ddd 1px", n.style.backgroundColor = "#fdfdfd", n.style.padding = "30px", HE.define.mobj.appendChild(n)
                }
            ...
            HE.define.obj.focus(), HE.sarea(!0)
        }, informat: function (e) {
            for (var i = HE.parentNode(), n = HE.parentNodeName(i), d = !1; "p" != n && "div" != n;) {
                if (HE.inArray(n, e)) {
                    d = !0;
                    break
                }
                i = HE.nextParentNode(i), n = HE.parentNodeName(i)
            }
            return d
        }, getTop: function (e) {
            ...
            n.type = "text/javascript", void 0 !== i && (n.readyState ? n.onreadystatechange = function () {
            ...
            i.type = "text/css", i.rel = "stylesheet", i.href = e;
            ...
            document.getElementById("HandyEditor_newdiv") && HE.deldiv(), 1 == HE.define.pre && (HE.define.pre = !1);
            for (var e, i = ["b", "i", "strike", "u", "em", "strong"], n = [], d = ["bold", "italic", "strike", "underline"], t = HE.parentNode(), o = HE.parentNodeName(t); HE.inArray(o, i);) "strong" != o && "b" != o || (o = "bold"), "em" != o && "i" != o || (o = "italic"), "u" == o && (o = "underline"), n.push(o), t = HE.nextParentNode(t), o = HE.parentNodeName(t);
            for (var a in d) e = document.getElementById(HE.getId(d[a])), HE.hasClass(e, "HandyEditor_menu_item_valid") && HE.removeClass(e, "HandyEditor_menu_item_valid");
            if (n.length > 0) for (var a in n) e = document.getElementById(HE.getId(n[a])), HE.hasClass(e, "HandyEditor_menu_item_valid") || HE.addClass(e, "HandyEditor_menu_item_valid");
            HE.sarea()
            ...
            var i = document.getElementById(HE.getId(e)), n = HE.findGroup(e);
            ...
            if (HE.define.mobj.blur(), document.getElementById("HandyEditor_newdiv")) HE.deldiv(); else {
                var i = document.getElementById(HE.getId(e)), n = document.createElement("div");
                if (n.className = "HandyEditor_newdiv", n.id = "HandyEditor_newdiv", "fontsize" == e) for (var d = [14, 16, 18, 24, 32, 48], t = '<div class="HandyEditor_newdiv_down" id="HandyEditor_newdiv_down_1" style="font-size:10px;" draggable="true">' + HE.define.lang.fontsize + "</div>", o = 0; o < d.length; o++) t += '<div class="HandyEditor_newdiv_gap"></div><div class="HandyEditor_newdiv_down" id="HandyEditor_newdiv_down_' + (o + 2) + '" style="font-size:' + d[o] + 'px;" draggable="true">' + HE.define.lang.fontsize + "</div>"; else if ("fontname" == e) {
                    t = "";
                ...
                } else if ("backcolor" == e) r = HE.getColor(), t = "<div>" + HE.define.lang.backcolor + ': <input style="border : solid 2px #ddd;padding: 5px;" type="text" id="HandyEditor_newdiv_down_backcolor" /><span class="HandyEditor_menu_item" id="HandyEditor_newdiv_down_backcolorok" style="display: inline-block;margin-left: 10px;" draggable="true">' + HE.define.lang.affirm + "</span></div><div>" + HE.define.lang.basecolor + '</div><div class="HandyEditor_newdiv_gap"></div><div>' + r[0] + "</div><div>" + HE.define.lang.topicolor + '</div><div class="HandyEditor_newdiv_gap"></div><div>' + r[1] + "</div>"; else if ("link" == e) t = "<div>" + HE.define.lang.urladdr + ': <input style="border : solid 1px #ddd;padding: 5px;" type="text" id="HandyEditor_newdiv_down_link" /><span class="HandyEditor_menu_item" id="HandyEditor_newdiv_down_linkok" style="display: inline-block;margin-left: 10px;" draggable="true">' + HE.define.lang.affirm + "</span></div>"; else if ("code" == e) {
                    t = "";
                    ...
                    if (1 == HE.config.uploadPhoto) {
                        var l = "", s = HE.config.uploadPhotoType.split(",");
                ...
                n.innerHTML = t, n.style.top = i.offsetTop + i.offsetHeight + "px", HE.define.mobj.appendChild(n);
                ...
                if (i.offsetLeft < n.offsetWidth / 2 && (H = 5), HE.define.mobj.offsetWidth - i.offsetLeft - i.offsetWidth < n.offsetWidth / 2 && (H = HE.define.mobj.offsetWidth - n.offsetWidth - 5), n.style.left = H + "px", n.onclick = function () {
                    ...
                    for (var a in HE.define.color.base) {
                        document.getElementById("HandyEditor_newdiv_down_colorblock_base_" + HE.define.color.base[a]).onclick = function () {
                            ...
                            e.value = "#" + this.title, e.style.borderColor = "#" + this.title
                        }
                    }
                    ...
                    if (document.getElementById("HandyEditor_newdiv_down_imageok").onclick = HE.imageokEx, 1 == HE.config.uploadPhoto) {
                        ...
                        u.onchange = function () {
                            var e = 1, i = u.value.lastIndexOf("."), n = u.value.substr(i + 1),
                            ...
                            0 != o && (o *= 1024) < u.files[0].size && (e = 2), 0 == e ? HE.uploadFile(u.files[0]) : 1 == e ? alert(HE.config.uploadPhotoTypeError) : 2 == e && alert(HE.config.uploadPhotoSizeError)
                        }
                    }
            ...
            1 == (n = n || !1) ? HE.define.obj.focus() : HE.resume(), i = i || null, document.execCommand(e, !1, i)
        }, getText: function () {
            return 1 == HE.define.html && (HE.define.obj.innerHTML = HE.define.tarobj.value), HE.define.obj.innerText
        }, getHtml: function () {
            return 1 == HE.define.html && (HE.define.obj.innerHTML = HE.define.tarobj.value), HE.define.obj.innerHTML
        }, set: function (e) {
            void 0 === HE.define.id ? HE.define.lastfuns.push(["HE.doset", "'" + e.replace(/\\/g, "\\\\").replace(/([^\\]?)\'/g, "$1\\'") + "'"]) : HE.doset(e)
        }, doset: function (e) {
            1 == HE.define.html && (HE.define.tarobj.value = e), HE.define.hetxt.value = e, HE.define.obj.innerHTML = e
        }, sync: function () {
            1 == HE.define.html && (HE.define.obj.innerHTML = HE.define.tarobj.value), HE.define.hetxt.value = HE.define.obj.innerHTML
        }, show: function () {
            1 == HE.define.html && (HE.define.tarobj.value = HE.define.hetxt.value), HE.define.obj.innerHTML = HE.define.hetxt.value
        }, clean: function () {
            HE.define.obj.innerHTML = "", HE.define.hetxt.value = "", HE.define.tarobj.value = ""
        }, bold: function () {
            HE.valid("bold"), HE.handy("bold")
        }, italic: function () {
            HE.valid("italic"), HE.handy("italic")
        }, strike: function () {
            HE.valid("strike"), HE.handy("strikeThrough")
        }, underline: function () {
            HE.valid("underline"), HE.handy("underline")
        }, fontsize: function () {
            HE.newdiv("fontsize")
        }, fontname: function () {
            HE.newdiv("fontname")
            ...
            HE.abolish(), HE.handy("removeFormat")
        }, image: function () {
            HE.newdiv("image")
        }, expression: function () {
            HE.newdiv("expression")
        }, subscript: function () {
            HE.valid("subscript"), HE.handy("subscript")
        }, superscript: function () {
            HE.valid("superscript"), HE.handy("superscript")
        }, horizontal: function () {
            ...
            HE.deldiv(), HE.handy("fontSize", parseInt(e[e.length - 1]))
        }, fontnameEx: function () {
            var e = this.id.split("_");
            HE.deldiv(), HE.handy("fontName", HE.define.font[e[e.length - 1]])
        }, cut: function () {
            HE.handy("cut")
        }, copy: function () {
            HE.handy("copy")
            ...
            HE.deldiv(), HE.handy("createLink", e.value)
        }, imageokEx: function () {
            var e = document.getElementById("HandyEditor_newdiv_down_image");
            HE.deldiv(), HE.handy("insertImage", e.value)
        }, uploadFile: function (e) {
            var i = document.getElementById("HandyEditor_newdiv_down_upload_percent"), n = new FormData;
            n.append("file", e);
            var d = HE.config.uploadParam;
            for (var t in d) n.append(t, d[t]);
            var o = new XMLHttpRequest;
            o.open("post", HE.config.uploadPhotoHandler, !0), o.upload.addEventListener("progress", function (e) {
                if (e.lengthComputable) {
                    var n = (e.loaded / e.total * 100).toFixed(0);
                    i.innerHTML = n + "%"
                }
            }, !1), o.addEventListener("readystatechange", function () {
                var e = o;
                if (4 == e.readyState) if (200 == e.status) {
                    setTimeout(function () {
                        i.innerHTML = "", document.getElementById("HandyEditor_newdiv_down_imageok").click()
                    }, 300);
                    var n = e.response.replace("\\", "/");
                    if (/^(http:\/\/|https:\/\/|\/)?(([\w\-]+\.)*[\w\-]+(\:\d+)?\/)?([\w\-]+\/)*[\w\-]+\.[A-Za-z]{2,4}$/i.test(n)) document.getElementById("HandyEditor_newdiv_down_image").value = n; else alert(e.response)
                } else alert(HE.define.lang.uploadimageerror)
            }), o.send(n)
        }, colorokEx: function () {
            var e = document.getElementById("HandyEditor_newdiv_down_color").value;
            HE.deldiv(), HE.handy("foreColor", e)
        }, backcolorokEx: function () {
            var e = document.getElementById("HandyEditor_newdiv_down_backcolor").value;
            HE.deldiv(), HE.handy("backColor", e)
        }, textblock: function () {
            ...
            var e = this.id.split("_"), i = e[e.length - 1];
            HE.deldiv();
            ...
            HE.handy("formatBlock", "<pre>"), n = HE.define.obj.getElementsByTagName("pre");
            ...
            HE.deldiv(), HE.handy("insertImage", e)
        }, paragraph: function () {
            HE.newdiv("paragraph")
        }, paragraphEx: function () {
            var e = this.id.split("_"), i = e[e.length - 1];
            HE.deldiv(), 7 != i ? HE.handy("formatBlock", "<h" + i + ">") : HE.handy("formatBlock", "<p>")
        }, html: function () {
            if (0 == HE.define.html) {
                HE.define.select || (HE.define.obj.focus(), HE.sarea());
                var e = document.createElement("div");
                e.style.width = HE.define.obj.offsetWidth - 2 * HE.define.obj.clientLeft + "px", e.style.height = HE.define.obj.clientHeight + "px", e.style.position = "absolute", e.style.top = HE.define.obj.offsetTop + HE.define.obj.clientTop + "px", e.style.left = HE.define.obj.offsetLeft + HE.define.obj.clientLeft + "px", e.style.border = "0px";
                var i = document.createElement("textarea");
                i.className = "HandyEditor_newtextarea_textarea", i.style.width = "100%", i.style.height = "100%", i.style.border = "0px", i.style.padding = "10px", i.style.outline = "none", e.appendChild(i);
                ...
                for (var d in n.insertBefore(e, HE.define.hetxt), HE.define.taobj = e, HE.define.tarobj = i, HE.define.inh = HE.define.obj.innerHTML, HE.define.inh = HE.define.inh.replace(/<p>(\S)/g, "<p>\n    $1"), HE.define.inh = HE.define.inh.replace(/(\S)<br><\/p>/g, "$1</p>"), HE.define.inh = HE.define.inh.replace(/(\S)<\/p>/g, "$1\n</p>"), HE.define.inh = HE.define.inh.replace(/<\/p><p>/g, "</p>\n<p>"), HE.define.inh = HE.define.inh.replace(/<\/p></g, "</p>\n<"), HE.define.inh = HE.define.inh.replace(/><p>/g, ">\n<p>"), HE.define.inh = HE.define.inh.replace(/">(\S)/g, '">\n$1'), HE.define.inh = HE.define.inh.replace(/(\S)<\/pre>/g, "$1\n</pre>"), HE.define.inh = HE.define.inh.replace(/><li>/g, ">\n    <li>"), HE.define.inh = HE.define.inh.replace(/><\/ol>/g, ">\n</ol>"), HE.define.inh = HE.define.inh.replace(/><div>/g, ">\n<div>"), HE.define.tarobj.value = HE.define.inh, HE.define.html = !0, HE.hasClass(this, "HandyEditor_menu_item_valid") || HE.addClass(this, "HandyEditor_menu_item_valid"), HE.config.item) {
                    if ("|" != (t = HE.trim(HE.config.item[d].toLowerCase())) && "html" != t && "about" != t) (o = document.getElementById("HandyEditor_" + HE.define.id + "_" + t)).onclick = null, HE.hasClass(o, "HandyEditor_menu_item_invalid") || HE.addClass(o, "HandyEditor_menu_item_invalid")
                }
                ...
                for (var d in n.removeChild(HE.define.taobj), HE.define.html = !1, HE.define.obj.focus(), HE.sarea(!0), HE.hasClass(this, "HandyEditor_menu_item_valid") && HE.removeClass(this, "HandyEditor_menu_item_valid"), HE.config.item) {
                    var t, o;
                    if ("|" != (t = HE.trim(HE.config.item[d].toLowerCase())) && "html" != t && "about" != t) (o = document.getElementById("HandyEditor_" + HE.define.id + "_" + t)).onclick = HE[t], HE.hasClass(o, "HandyEditor_menu_item_invalid") && HE.removeClass(o, "HandyEditor_menu_item_invalid")
                }
            }
        }
    }
